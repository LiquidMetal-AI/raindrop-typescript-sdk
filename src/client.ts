...
import { ChunkSearch, ChunkSearchCreateParams, ChunkSearchCreateResponse } from './resources/chunk-search';
import {
  DocumentQuery,
...
export interface ClientOptions {
  /**
   * API key with format 'Bearer lm_apikey_...' that grants access to specific buckets or organization-wide access
   */
